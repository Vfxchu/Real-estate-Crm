...
import { Phone, Mail, MessageSquare, MapPin, Building, Edit, X, Bed, Bath, Square, FileText, Activity, Home, Image as ImageIcon } from 'lucide-react';
  ...
  const loadActivities = async () => {
    ...
    try {
      const {
        ...
        `).eq('property_id', property.id).order('created_at', {
        ascending: false
      }).limit(50);
  ...
  const loadFiles = async () => {
    ...
    try {
      const {
        data,
        error
      } = await supabase.from('property_files').select('*').eq('property_id', property.id).order('created_at', {
        ascending: false
      });
      if (error) throw error;
      setFiles(data || []);
          ...
          <div className="p-6">
            ...
            <SheetHeader className="space-y-4 pb-6 border-b">
              <div className="flex items-start justify-between">
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {property.profiles && <Badge variant="outline" className="flex items-center gap-1">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                {canEdit && <Button size="sm" variant="default" onClick={() => onEdit?.(property as Property)}>
              ...
              {/* Agent Info */}
              {property.profiles && <div className="flex items-center gap-3 pt-2">
            ...
            <Tabs defaultValue="overview" className="mt-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <div className="text-sm">
                      ...
                      {canViewSensitive && property.unit_number && <div className="text-muted-foreground">Unit {property.unit_number}</div>}
                ...
                {files.length > 0 && <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {files.slice(0, 3).map(file => <div key={file.id} className="flex items-center gap-2 text-sm">
                ...
                {activities.length > 0 && <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {activities.slice(0, 5).map(activity => <div key={activity.id} className="flex items-start gap-2 text-sm border-l-2 border-muted pl-3">
              ...
              <TabsContent value="images" className="mt-4 space-y-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    {property.images && property.images.length > 0 ? <PropertyImageGallery images={property.images} propertyId={property.id} /> : <div className="text-center py-8 text-muted-foreground">
                ...
                <Card>
                  ...
                  <CardContent>
                    <PropertyLayoutGallery propertyId={property.id} canEdit={canEdit} onUpdate={onUpdate} />
                  </CardContent>
                </Card>
              </TabsContent>
              ...
              {canViewSensitive && <TabsContent value="documents" className="mt-4">
                  <PropertyFilesSection propertyId={property.id} canEdit={canEdit} onUpdate={() => {
                onUpdate?.();
                loadFiles();
              }} />
                </TabsContent>}
                        ...
                        <CardContent className="py-3">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 space-y-1">
                              ...
                              {activity.profiles && <p className="text-xs text-muted-foreground">
