-- SECURITY FIXES - Step 2: Clean up function conflicts and apply all security fixes

-- Drop all variants of get_current_user_role functions
...
-- Create the wrapper function that policies expect (without parameters)
...
-- Fix properties RLS - remove the overly permissive policy
...
-- Attach missing security triggers
