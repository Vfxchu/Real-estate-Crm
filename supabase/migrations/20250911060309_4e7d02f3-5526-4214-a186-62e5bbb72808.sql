-- Complete CRM Database Setup for New Supabase Instance
...
CREATE POLICY "Agents can view contact files" ON public.contact_files
FOR SELECT USING (is_agent());

CREATE POLICY "Agents can create contact files" ON public.contact_files
FOR INSERT WITH CHECK (is_agent());

CREATE POLICY "Agents can update contact files" ON public.contact_files
FOR UPDATE USING (is_agent());

CREATE POLICY "Agents can delete contact files" ON public.contact_files
FOR DELETE USING (is_agent());

-- RLS Policies for property_files
CREATE POLICY "Agents can view property files" ON public.property_files
FOR SELECT USING (is_agent());

CREATE POLICY "Agents can create property files" ON public.property_files
FOR INSERT WITH CHECK (is_agent());

CREATE POLICY "Agents can update property files" ON public.property_files
FOR UPDATE USING (is_agent());

CREATE POLICY "Agents can delete property files" ON public.property_files
FOR DELETE USING (is_agent());
