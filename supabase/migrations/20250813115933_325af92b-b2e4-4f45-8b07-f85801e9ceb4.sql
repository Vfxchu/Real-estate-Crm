-- Phase 2: Fix Security Warnings and Continue Security Hardening
...
-- 2. Add additional security constraints for file operations
...
AS $$
DECLARE
    allowed_types TEXT[] := ARRAY['image/jpeg', 'image/png', 'image/webp', 'application/pdf', 'text/plain'];
...
-- Apply file validation to property_files
...
-- Apply file validation to contact_files
